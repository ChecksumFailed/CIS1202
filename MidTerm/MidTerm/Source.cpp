...
void loadArrays(string arr[][NUMFIELDS], int &, string); //Read in file and load array
...
Date : 10/7/2018
Program Description : Mid Term prooject.  Movie database.  Supports CRUD operations and peristent changes.
*/
int main() {
	string movies[500][NUMFIELDS]; //2d array to store movie details.  
...
void printMovies(string *arr, int size) {
	...
	cout << setw(20) << "Title" << setw(20) << "Year" << setw(20) << "Genre" << setw(20) << "Rating" << endl;
...
void loadArrays(string arr[][NUMFIELDS], int &size, string filePath) {
